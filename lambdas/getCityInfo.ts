...
// We use ? for optional chaining, similar to as in Swift. Here it means if pathparameter is
// truthy then get the city paramater, else return undefined
...
// creating an object named cityDate and stating it will conform to the CityData interface
